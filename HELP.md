...
* The following dependency is not known to work with Spring Native: 'Oracle Driver'. As a result, your application may
...
```
$ docker run --rm -p 8080:8080 Spring_pra2:0.0.1-SNAPSHOT
```
...
```
$ build/native-image/Spring_pra2
```
